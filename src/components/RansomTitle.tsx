    ...
    <div className="flex flex-col items-start select-none">
      ...
      <div className="flex items-center gap-1.5 md:gap-2.5 my-1 filter drop-shadow-[6px_6px_0px_rgba(0,0,0,0.9)]">
        {LETTERS.map((item, idx) => (
          <div
            key={idx}
            className="p5-tile-entrance"
            style={{ animationDelay: `${idx * 45 + 50}ms` }}
          >
            <div
      ...
      {/* Sub-label banner */}
      <div
        className="mt-1 flex items-center bg-black border-l-4 border-p5-crimson px-3.5 sm:px-4.5 py-1 md:py-1.5 text-xs md:text-sm font-p5Sub tracking-wider md:tracking-widest text-white -skew-x-6 shadow-[3px_3px_0px_#E60012] w-fit max-w-full laptop-ransom-sub p5-sub-entrance"
